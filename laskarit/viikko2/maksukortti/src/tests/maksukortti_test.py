...
class TestMaksukortti(unittest.TestCase):
    ...
    def kortilla_pystyy_ostamaan_edullisen_lounaan_jos_rahaa_edullisen_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def kortilla_pystyy_ostamaan_maukkaan_lounaan_jos_rahaa_maukkaan_lounaan_verran(self):
